...
OPENAI_GENERIC_MODEL = os.getenv("OPENAI_GENERIC_MODEL", "gpt-4o-mini-2024-07-18")
OPENAI_CLASSIFICATION_MODEL = os.getenv(
    "OPENAI_CLASSIFICATION_MODEL", "gpt-4o-mini-2024-07-18"
)
OPENAI_REASONING_MODEL = os.getenv(
    "OPENAI_REASONING_MODEL", "gpt-4o-mini-2024-07-18"
)
NO_RESPONSE_MODEL = os.getenv("NO_RESPONSE_MODEL", "gpt-4o-mini-2024-07-18")
...
PROFILE_EXTRACTION_MODEL = os.getenv("PROFILE_EXTRACTION_MODEL", "gpt-5-nano")
