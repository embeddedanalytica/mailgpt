...
This file is the coding-agent execution spec for implementing the autonomous closed-loop behavior described in [run-prompt-feedback-loop-spec.md](./run-prompt-feedback-loop-spec.md).
